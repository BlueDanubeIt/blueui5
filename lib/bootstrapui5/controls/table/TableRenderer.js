...
de.pksoftware.bootstrapui5.controls.table.TableRenderer.render = function(oRm, oTable) {
	...
	if (this._oPaginator) {
		if(oTable._oPaginator.getLast() > 0){
			oRm.renderControl(oTable._oPaginator);
		}
	}
	
//	this.renderPaginator(oRm, oTable);
};
 ...
 * @param {de.pksoftware.bootstrapui5.controls.table.Table} oTable
 */
//de.pksoftware.bootstrapui5.controls.table.TableRenderer.renderPager = function(oRm, oTable) {
//	
//};
 ...
 * @param {de.pksoftware.bootstrapui5.controls.table.Table} oTable
 */
//de.pksoftware.bootstrapui5.controls.table.TableRenderer.renderPaginator = function(oRm, oTable) {
//	oRm.renderControl(oTable._oPaginator);
//};
...
de.pksoftware.bootstrapui5.controls.table.TableRenderer.renderHeader = function(oRm, oTable) {
	...
	oTable.getColumns().forEach(function(oCol){
		oRm.write('<th>');
		oRm.renderControl(oCol.getHeader());
		oRm.write('</th>');
	});
	oRm.write('</tr></thead>');
};
